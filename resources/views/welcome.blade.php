        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">        
                    <div>
                        <a href="{{ route('social.oauth','google') }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                            <span class="sr-only">Sign in with Google</span>
                            <img class="w-5 h-5" src="https://img.icons8.com/color/50/000000/google-logo.png"/>
                        </a>
                    </div>
